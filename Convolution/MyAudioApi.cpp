...
WaveShell* MyAudioApi::GetWaveShellLeft(AudioId id){
	if(IsActive(id)){
		return audioList[id]->GetWaveShellLeft();
	}else{
		return NULL;
	}
}
WaveShell* MyAudioApi::GetWaveShellRight(AudioId id){
	if(IsActive(id)){
		return audioList[id]->GetWaveShellRight();
	}else{
		return NULL;
	}
}
